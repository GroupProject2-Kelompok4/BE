...
func (_m *UserService) UpdateProfile(userId string, request user.UserCore) (user.UserCore, error) {
...
func (_m *UserService) UpdateUserProfile(userId string, request user.UserCore) (user.UserCore, error) {
	ret := _m.Called(userId, request)
