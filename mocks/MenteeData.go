...
func (_m *MenteeData) SearchMentee(keyword string, limit int, offset int) ([]mentee.MenteeCore, uint, error) {
...
func (_m *MenteeData) UpdateMentee(menteeId string, request mentee.MenteeCore) error {
